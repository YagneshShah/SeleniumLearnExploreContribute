...
public class WebCommonMethods extends SelectBrowser {
	...
	public static void callingImplicitSleep() throws IOException{
		FileReader reader = new FileReader("../orangeHRM/config.properties"); 
		Properties prop = new Properties();
		prop.load(reader); 
		int implicitWaitTime = Integer.parseInt(prop.getProperty("implicitWaitTime"));
		//System.out.println("implicitWaitTime: " + implicitWaitTime);
	...
	public static void screenshot(String methodName) {
		...
		try {
			FileUtils.copyFile(scrFile, new
					File(("../orangeHRM/failure_screenshots/" + methodName + "_" + formater.format(calendar.getTime())+".png")));
			Reporter.log("<a href='" +
					"../orangeHRM/failure_screenshots/" + methodName + "_" + formater.format(calendar.getTime()) + ".png'> <imgsrc='" + "C:/failure_screenshots/" + methodName + "_" + formater.format(calendar.getTime()) + ".png' /> </a>");
