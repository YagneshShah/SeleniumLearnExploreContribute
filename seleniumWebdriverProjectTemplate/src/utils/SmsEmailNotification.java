...
public class SmsEmailNotification {  
	...
	public void sendEmail(){  
		...
		try{  
			...
			String filename2 = "../seleniumWebdriverProjectTemplate/test-output/emailable-report.html";//change accordingly
			...
			String filename3 = "../seleniumWebdriverProjectTemplate/test-output/testng-results.xml";//change accordingly
