...
public class WebCommonMethods extends SelectBrowser {
	...
	public static void callingImplicitSleep() throws IOException{
		FileReader reader = new FileReader("../seleniumWebdriverProjectTemplate/config.properties"); 
		Properties prop = new Properties();
		prop.load(reader); 
	...
	public static void screenshot(String methodName) {
		...
		try {
			FileUtils.copyFile(scrFile, new
					File(("../novoseleniumWebdriverProjectTemplatepay/failure_screenshots/" + methodName + "_" + formater.format(calendar.getTime())+".png")));
			Reporter.log("<a href='" +
					"../seleniumWebdriverProjectTemplate/failure_screenshots/" + methodName + "_" + formater.format(calendar.getTime()) + ".png'> <imgsrc='" + "C:/failure_screenshots/" + methodName + "_" + formater.format(calendar.getTime()) + ".png' /> </a>");
	...
	{
		wrk1 = Workbook.getWorkbook(new File("../seleniumWebdriverProjectTemplate/testdata/webTestData.xls")); // Connecting to excel workbook.
