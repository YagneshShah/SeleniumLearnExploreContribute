...
public class SelectBrowser {
	...
	public static WebDriver getBrowser() throws IOException {
		...
		if(browser.equalsIgnoreCase("ieWinx32"))
		{
			...
			System.setProperty("webdriver.ie.driver", "../seleniumWebdriverLearningSnippets/webdrivers/IEDriverServer_x32_v2.43.0.exe"); // setting path of the IEDriver
...
//			alert.dismiss()
		...
		{
			//String path=System.getProperty("user.dir") +File.separator + "Browsers"+ File.separator +"IEDriverServer.exe";
			System.setProperty("webdriver.ie.driver", "../seleniumWebdriverLearningSnippets/webdrivers/IEDriverServer_x64_v2.43.0.exe"); // setting path of the IEDriver
			DesiredCapabilities ieCapabilities = DesiredCapabilities.internetExplorer();
			ieCapabilities.setCapability(InternetExplorerDriver.INTRODUCE_FLAKINESS_BY_IGNORING_SECURITY_DOMAINS, true);
			driver = new InternetExplorerDriver(ieCapabilities);
		}
			...
			System.setProperty("webdriver.chrome.driver", "../seleniumWebdriverLearningSnippets/webdrivers/chromedriver_x32_v2.10.exe"); // setting path of the ChromeDriver
			driver = new ChromeDriver();
		}
		else if(browser.equalsIgnoreCase("chromeMac32")){
			//String path=System.getProperty("user.dir") +File.separator + "Browsers"+ File.separator +"chromedriver.exe";
			//System.out.println(path);
			System.setProperty("webdriver.chrome.driver", "../seleniumWebdriverLearningSnippets/webdrivers/chromedriver_mac32_v2.10"); // setting path of the ChromeDriver
			driver = new ChromeDriver();
		}
		else if(browser.equalsIgnoreCase("chromeLinux64")){
			//String path=System.getProperty("user.dir") +File.separator + "Browsers"+ File.separator +"chromedriver.exe";
			//System.out.println(path);
			System.setProperty("webdriver.chrome.driver", "../seleniumWebdriverLearningSnippets/webdrivers/chromedriver_linux64_v2.10"); // setting path of the ChromeDriver
			driver = new ChromeDriver();
		}
		return driver;
	}
