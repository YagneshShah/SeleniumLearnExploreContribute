...
public class SelectBrowser {
	...
	public static WebDriver getBrowser() throws IOException {
		...
		if(browser.equalsIgnoreCase("IE"))
		{
			...
			System.setProperty("webdriver.ie.driver", "../seleniumWebdriverLearningSnippets/webDrivers/IEDriverServer.exe"); // setting path of the IEDriver
			...
			System.setProperty("webdriver.chrome.driver", "../seleniumWebdriverLearningSnippets/webDrivers/chromedriver.exe"); // setting path of the ChromeDriver
